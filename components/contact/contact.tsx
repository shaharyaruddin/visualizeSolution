  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold text-black dark:text-white mb-10 font-heading">
            Let's <span className="text-[#288dc8]">Work Together</span>
          </h2>
          <p className="text-black max-w-2xl mx-auto text-lg mb-10 font-manrope">
